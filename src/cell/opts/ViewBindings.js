...
define(['cell/View'], function(View) {
  var AttrBind, Bind, EachBind, ElBind, HashQueue, IfBind, bind, hashkey, hashuid, isBind, nextuid, orig__each, orig__if, orig_constructor, orig_remove, orig_renderAttr, orig_renderChild, __;
  isBind = function(o) {
