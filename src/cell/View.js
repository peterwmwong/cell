...
define(['util/hash', 'util/type', 'util/fn', 'dom/data', 'dom/events', 'cell/Model', 'cell/Collection', 'cell/util/spy'], function(hash, _arg, fn, data, events, Model, Collection, _arg1) {
  var Bind, EachBind, HashQueue, IfBind, View, bind, d, isA, isF, noop, removeChildren, render, watch, __;
  ...
  return View = Model.extend({
    ...
    _re: function() {
      ...
      el.className = (cls = el.className) ? cls + ' ' + this._cellName : this._cellName;
      data.set(el, 'cellRef', this);
      el.setAttribute('cell', this._cellName);
