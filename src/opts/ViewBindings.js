...
define(['underscore', 'cell/View'], function(_, View) {
  var AttrBind, Bind, EachBind, ElBind, HashQueue, IfBind, hashkey, hashuid, isBind, nextuid, orig__each, orig__if, orig_constructor, orig_remove, orig_renderAttr, orig_renderChild, __;
  isBind = _.isFunction;
  ...
  View.prototype._renderAttr = function(k, v, parent) {
    var bind;
    if (isBind(v)) {
      this._binds.push(bind = new AttrBind(parent, k, _.bind(v, this)));
      bind.needRender();
      bind.render(this);
    }
  };
  ...
  View.prototype._renderChild = function(n, parent, insertBeforeNode, rendered) {
    if (isBind(n)) {
      n = new Bind(parent, _.bind(n, this));
    }
