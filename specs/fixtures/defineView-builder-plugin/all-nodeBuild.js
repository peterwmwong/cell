...
;
// Generated by CoffeeScript 1.6.2
define('cell/View',['cell/Collection', 'cell/Ext', 'cell/Model', 'cell/util/spy', 'dom/data', 'dom/events', 'dom/mutate', 'util/fn', 'util/hash', 'util/type'], function(Collection, Ext, Model, _arg, data, events, mutate, fn, hash, type) {
  var EachBind, EachBindOnChange, HashQueue, View, d, noop, protoProp, removeChildren, suspendWatch, unwatch, watch, _, _each;
