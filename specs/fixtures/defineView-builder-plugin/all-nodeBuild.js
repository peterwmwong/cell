...
define('cell/util/spy',['util/hash', 'util/fn', 'util/type'], function(hash, fn, type) {
  var addLog, allChanges, doAfter, evaluateAndMonitor, log, logObjMap, logStack, onChange, onChangeCalled, watches, _onChange;
  logStack = [];
  ...
  evaluateAndMonitor = function(context) {
    var accesslog, accesslogObjMap, event, events, i, key, keyEvent, obj, prevObjMap, prevlog, removes, temp, value;
    if (log) {
      logStack.push([log, logObjMap]);
    }
    log = {};
    logObjMap = {};
    value = context.e();
