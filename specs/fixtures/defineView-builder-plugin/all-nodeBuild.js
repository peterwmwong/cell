...
define('cell/View',['util/type', 'util/fn', 'dom/data', 'dom/events', 'dom/mutate', 'cell/Model', 'cell/Ext', 'cell/util/spy'], function(_arg, fn, data, events, mutate, Model, Ext, _arg1) {
  var View, d, isA, isF, isS, noop, protoProp, suspendWatch, unwatch, watch;
  isA = _arg.isA, isF = _arg.isF, isS = _arg.isS;
  watch = _arg1.watch, unwatch = _arg1.unwatch, suspendWatch = _arg1.suspendWatch;
  protoProp = 'prototype';
  noop = function() {};
  d = document;
