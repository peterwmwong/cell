...
define('cell/Events',['cell/util/ev', 'cell/util/extend', 'cell/util/hash', 'cell/util/spy', 'cell/util/type'], function(ev, extend, hash, spy, type) {
...
define('cell/Collection',['cell/Events', 'cell/util/type', 'cell/Model', 'cell/util/spy'], function(Events, type, Model, spy) {
  ...
  return Collection = Events.extend({
    ...
    _toM: function(o) {
      o = o instanceof this.Model ? o : new this.Model(o);
      o._setParent(this);
      return o;
    },
    _s: spy.addCol
...
;
// Generated by CoffeeScript 1.6.3
define('cell/dom/mutate',['cell/dom/data', 'cell/dom/browser'], function(data, browser) {
  var dealloc, toArray;
