...
define('__',['cell', 'underscore'], function(_arg, _) {
  ...
  __ = function() {
    ...
    if (a) {
      ...
      parent = typeof a === 'string' ? (haml = _parseHAML(a)) ? (el = document.createElement(haml.tag), haml.id ? el.setAttribute('id', haml.id) : void 0, haml.className ? el.className = haml.className : void 0, b != null ? _isObj(b) ? _.each(b, function(v, k) {
        if (v instanceof Bind) {
          v.bindToAttr(el, k);
        } else {
          el.setAttribute(k, v);
        }
      }) : children.unshift(b) : void 0, el) : void 0 : a.prototype instanceof Cell ? (cell_options = (typeof b === 'string') && (haml = _parseHAML(b)) ? _isObj(children[0]) ? ((c = children.shift()).id = haml.id, c.className = haml.className, c) : {
        id: haml.id,
        className: haml.className
      } : _isObj(b) ? b : void 0, cell_options ? cell_options.className = cell_options.className ? "" + a.prototype.className + " " + cell_options.className : a.prototype.className : void 0, (new a(cell_options)).render().el) : _.isElement(a) ? a : void 0;
      if (!parent) {
