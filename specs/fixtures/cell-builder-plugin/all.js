...
function uppercase(string){return _.isString(string) ? string.toUpperCase() : string;};

var forEach = _.each,
    msie = Number((/msie (\d+)/.exec(lowercase(navigator.userAgent)) || [])[1]);
  ...
  attr: function(element, name, value){
    ...
    if (BOOLEAN_ATTR[lowercasedName]) {
      if (isDefined(value)) {
        ...
        return (element[name] ||
                 (element.attributes.getNamedItem(name)|| function(){}).specified)
               ? lowercasedName
               : undefined;
      }
