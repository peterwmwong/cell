...
define('cell',['backbone', 'jquery'], function(Backbone, $) {
  var AttrBind, Bind, EachBind, ElBind, HashQueue, IfBind, cidMap, hashkey, hashuid, isArrayish, isBind, module, nextuid, origCleanData, textNode, __, __each, __if;
...
define('App',['require','./Mock','jquery','backbone'],function(require) {
  var $, Backbone, Mock;
  Mock = require('./Mock');
  $ = require('jquery');
