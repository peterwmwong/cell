    ...
    return describe('modifies View.__() method signature ( viewOrSelector:[Backbone.View, String], exts...:Ext, attrHash_or_options?:Object, children...:[DOMNode, String, Number, Array, jQuery] )', function() {
      ...
      describe('__( selector:String, exts...:Ext )', function() {
        ...
        it('calls Ext.run(element) for each ext', function() {
          ...
          expect(this.x_test2_func).toHaveBeenCalledWith(this.element, this.x_test2_options);
      ...
      return describe('__( selector:String, exts...:Ext, children...:[DOMNode, String, Number, Array] )', function() {
        beforeEach(function() {
