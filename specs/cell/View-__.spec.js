...
define(['../utils/spec-utils'], function(_arg) {
  ...
  return function(_arg1) {
    var beforeEachRequire, useViewBindings, _i, _len, _ref, _results;
    beforeEachRequire = _arg1.beforeEachRequire;
    _ref = [true, false];
    _results = [];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      useViewBindings = _ref[_i];
      _results.push((function(useViewBindings) {
        return describe("" + (useViewBindings ? 'WITH' : 'WITHOUT') + " cell/opts/ViewBindings", function() {
          var DEPS, beforeEachRun;
          DEPS = ["fixtures/TestCell1", 'cell/View'];
          beforeEachRun = function(TestCell1, View) {
          ...
          describe('__( viewOrSelector:[View, String], attrHash_or_options?:Object, children...:[DOMNode, String, Number, Array] )', function() {
            var empty, it_renders, it_renders_views, _fn, _j, _len1, _ref1;
          ...
          describe('__.if( condition:truthy, {then:function, else:function} )', function() {
            ...
            describe('when then and else are provided', function() {
              ...
              it('when condition is truthy, renders then', function() {
                var truthy, _j, _len1, _ref1, _results1;
                _ref1 = [true, 1, '1', [], {}];
                _results1 = [];
                for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
                  truthy = _ref1[_j];
                  _results1.push(expect(this.__["if"](truthy, this.thenElse)).toEqual(this.thenNode));
                }
                return _results1;
              });
              return it('when condition is falsy, renders else', function() {
                var falsy, _j, _len1, _ref1, _results1;
                _ref1 = [false, 0, '', void 0, null];
                _results1 = [];
                for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
                  falsy = _ref1[_j];
                  _results1.push(expect(this.__["if"](falsy, this.thenElse)).toEqual(this.elseNode));
                }
                return _results1;
              });
            });
          ...
          describe('__.each( many:array, renderer:function )', function() {
            ...
            it('when many is non-empty array', function() {
              var i, item, result, _j, _len1, _ref1;
          ...
          return describe('__.each( many:array, view:View )', function() {
            beforeEach(function() {
