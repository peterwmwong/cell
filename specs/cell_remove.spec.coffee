define ['./spec-utils'], ({nodeHTMLEquals,stringify,node})->
  ...
  ({beforeEachRequire})->
    ...
    describe 'Remove', ->
      ...
      describe 'Removing an ancestor DOM element using $.remove()', ->
        beforeEach ->
      ...
      describe "Removing a cell's element using $.remove()", ->
        beforeEach ->
      ...
      describe "Removing a nested cell's element using $.remove()", ->
        beforeEach ->
      ...
      describe "Removing a leaf (cell doesn't contain any other cell) cell's element using $.remove()", ->
        beforeEach ->
