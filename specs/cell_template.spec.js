...
(function() {
  ...
  define(['./spec-utils'], function(_arg) {
    var NODE, TestCell1Name, nodeHTMLEquals, nodeToHTML;
      ...
      return describe('cell.__()', function() {
        ...
        it_renders = function(desc, input_args, expected_html_output, debug) {
          return describe(desc, function() {
            return it("__(" + (input_args.join(',')) + ") === '" + expected_html_output + "'", function() {
              if (debug) {
                debugger;
              }
        ...
        it_renders_cell = function(desc, input_args, expected_html_output, debug) {
          return describe(desc, function() {
            return it("__(Cell, '" + (input_args.join(',')) + "') === '" + expected_html_output + "'", function() {
              if (debug) {
                debugger;
              }
        ...
        it_renders_cell("cell:<cell>", [], '<div class="TestCell1"></div>');
        it_renders_cell("cell:<cell>, options:<Object>", [
          {
            tagName: 'span'
          }
        ], '<span class="TestCell1"></span>');
        it_renders_cell("cell:<cell>, Selector String:<String>", ['#myid.myclass.myclass2'], '<div class="TestCell1 myclass myclass2" id="myid"></div>');
