  ...
  define(['./spec-utils'], function(_arg) {
    ...
    return function(_arg1) {
      ...
      describe('render_el', function() {
        ...
        it_renders('jQuery-ish Object', $('<span class="jQueryObj"></span><span class="jQueryObjDeux"></span>'), '<div class="TestCell1"><span class="jQueryObj"></span><span class="jQueryObjDeux"></span></div>');
        return it_renders('Array of Nodes, Strings, Numbers, jQuery-ish Object', [node('span'), 'hello', [node('table'), 'world', 5, [node('div')]], 0, node('a'), $('<span class="jQueryObj"></span><span class="jQueryObjDeux"></span>')], '<div class="TestCell1"><span></span>hello<table></table>world5<div></div>0<a></a><span class="jQueryObj"></span><span class="jQueryObjDeux"></span></div>');
      });
