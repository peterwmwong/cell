...
define(['spec-utils'], function(_arg) {
  ...
  return function(_arg1) {
    ...
    }, ['cell/Model', 'cell/Collection', 'cell/Resource', 'cell/util/spy'], function(Model, Collection, Resource, spy) {
      this.Model = Model;
    ...
    return describe('@watch( context:any, func:function, callback:function, callContext?:any, immediate?:boolean )', function() {
      beforeEach(function() {
        this.context = {};
        this.value = {};
        return this.callback = jasmine.createSpy('callback');
      });
      describe("when immediate is specified...", function() {
        beforeEach(function() {
          var _this = this;
          this.model = new this.Model({
            a: 1
          });
          return this.func = jasmine.createSpy('func').andCallFake(function() {
            return _this.model.get('a');
          });
        });
        describe("true", function() {
          beforeEach(function() {
            this.watch(this.context, this.func, this.callback, this.context, true);
            return this.callback.reset();
          });
          return it("When watched expression (func) changes, calling callback is NOT deferred", function() {
            this.model.set('a', 2);
        ...
        return describe("false", function() {
          beforeEach(function() {
            this.watch(this.context, this.func, this.callback, this.context, false);
            return this.callback.reset();
          });
          return it("When watched expression (func) changes, calling callback is NOT deferred", function() {
            this.model.set('a', 2);
      ...
      describe("When func accesses a Model's parent()", function() {
        beforeEach(function() {
          var _this = this;
          this.model = new this.Model({
            a: 1,
        ...
        it('call @callback with result of func', function() {
          expect(this.func.callCount).toBe(1);
          expect(this.func.calls[0].object).toBe(this.context);
          expect(this.callback).toHaveBeenCalledWith(void 0);
          expect(this.callback.callCount).toBe(1);
          return expect(this.callback.calls[0].object).toBe(this.context);
        });
        return describe('when the accessed model parent changes', function() {
          beforeEach(function() {
            this.func.reset();
            this.callback.reset();
            return this.model._setParent(this.newParent = new this.Model);
          });
          return it('calls callback with result of func', function() {
            return waitOne(function() {
              expect(this.func.callCount).toBe(1);
              expect(this.callback).toHaveBeenCalledWith(this.newParent);
      ...
      describe("When func accesses a Resource.status()", function() {
        beforeEach(function() {
          var _this = this;
          ...
          this.func = jasmine.createSpy('func').andCallFake(function() {
            return _this.resourceItem.status();
          });
          return this.watch(this.context, this.func, this.callback);
        });
        it('call @callback with result of func', function() {
          expect(this.func.callCount).toBe(1);
          expect(this.func.calls[0].object).toBe(this.context);
          expect(this.callback).toHaveBeenCalledWith('loading');
          expect(this.callback.callCount).toBe(1);
          return expect(this.callback.calls[0].object).toBe(this.context);
        });
        return describe('when the accessed Resource status changes', function() {
          beforeEach(function() {
            this.func.reset();
            this.callback.reset();
          ...
          return it('calls callback with result of func', function() {
            return waitOne(function() {
              expect(this.func.callCount).toBe(1);
              expect(this.func.calls[0].object).toBe(this.context);
              expect(this.callback).toHaveBeenCalledWith('ok');
              expect(this.callback.callCount).toBe(1);
              return expect(this.callback.calls[0].object).toBe(this.context);
            });
          });
      ...
      return describe("When func accesses a Collection", function() {
        ...
        describe('and access changes', function() {
          beforeEach(function() {
            var _this = this;
            return this.watch(this.context, function() {
              if (_this.col.length() === 2) {
                return _this.col.add({
                  z: 'z val'
                });
              } else {
                return _this.col.at(0).get('x');
          ...
          return describe('collection changes', function() {
            beforeEach(function() {
              this.col.add({
                a: 'a val'
              });
        ...
        describe('using parent()', function() {
          beforeEach(function() {
            var _this = this;
            this.watch(this.context, (function() {
              return _this.col.parent();
            }), this.callback);
            return this.callback.reset();
          });
          return describe("when the Collection's parent changes", function() {
            beforeEach(function() {
              return this.col._setParent(this.newParent = new this.Model);
            });
            return it('calls callback with result of func', function() {
              return waitOne(function() {
                expect(this.callback).toHaveBeenCalledWith(this.newParent);
