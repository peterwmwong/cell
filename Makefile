...
all: build/cell.js build/cell-builder-plugin.js build/require.js build/require-min.js
...
build/cell-builder-plugin.js: lib/cell-builder-plugin.coffee $(coffee)
	mkdir -p build/
...
test: $(coffee) test-cell-builder-plugin
