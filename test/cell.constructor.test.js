  ...
  define(function() {
    ...
    return {
      ...
      'constructor() when cell::tag is "<p>"': function() {
        var NewCell;
        NewCell = cell.extend({
          tag: '<p>'
        });
      ...
      'constructor() when cell::tag is "<p id=\'testId\' class=\'testClass\' data-customattr=\'testAttr\'>"': function() {
        var NewCell;
        NewCell = cell.extend({
      ...
      'constructor({id:<string>,class:<string>}) when cell::tag is "<p id=\'testId\' class=\'testClass\' data-customattr=\'testAttr\'>"': function() {
        var NewCell;
        NewCell = cell.extend({
          tag: "<p id=\'testId\' class=\'testClass\' data-customattr=\'testAttr\'>"
        });
      ...
      'constructor(options:<object>) calls init() then render()': function() {
